...
new_model_path = "/remote-home/zyfei/project/tianchi/model_output/nezha_base_output_with_label_without_round1"

cache_path = "/remote-home/zyfei/project/tianchi/cache/nezha-base-4-23-with-label"
    ...
    def __init__(self, tokenizer: PreTrainedTokenizer, file_path: str, block_size: int):
        ...
        self.examples = [
            {"input_ids": torch.tensor(e, dtype=torch.long),
             "token_type_ids": torch.tensor(t, dtype=torch.long),
             "matched_labels": torch.tensor(l, dtype=torch.int)} for e, t, l in zip(example_ids, example_tokens, labels)]
...
model = NeZhaForPreTrainingWithLabel(config=config)
