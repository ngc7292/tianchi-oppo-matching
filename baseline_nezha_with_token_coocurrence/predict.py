...
from furnturning_n_gram import MatchingDataset, load_data, DataLoader
...
pred = run_kfold_pred(test_loader, test_texts, device=device, model_dir='./kfold-3')

with open('./result-3.txt', 'w') as f:
    for val in pred:
        f.write(str(val) + '\n')
