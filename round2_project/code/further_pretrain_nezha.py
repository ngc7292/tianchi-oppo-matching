...
tokenizer_path = "../origin_model"

model_name_or_path = "../origin_model"

new_model_path = "../model_output"

print(f"data path is {raw_text}, origin model is {model_name_or_path}, and trained model saved {new_model_path}, tokenizer is {tokenizer_path}")
