...
from modeling_nezha import NeZhaForSequenceClassificationWithClsCatForOnnx, NeZhaForSequenceClassificationWithClsCat, NeZhaConfig, NeZhaForMaskedLM
...
class LineByLineTextDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.tensor]:
        ...
        batch_encoding = self.tokenizer(text=text_1, text_pair=text_2, add_special_tokens=True, truncation=True,
...
def main():
    ...
    if args.config_name:
        config = NeZhaConfig.from_pretrained(args.config_name)
    ...
    if args.model_name_or_path:
        model = NeZhaForMaskedLM.from_pretrained(
    ...
    train_dataset = LineByLineTextDataset(tokenizer=tokenizer, file_path=args.dataset_name, block_size=64)
    # eval_dataset = LineByLineTextDataset(tokenizer=tokenizer, file_path=args.train_file, block_size=64)
    ...
    data_collator = DataCollatorForLanguageModelingNgram(tokenizer, mlm_probability=args.mlm_probability)
