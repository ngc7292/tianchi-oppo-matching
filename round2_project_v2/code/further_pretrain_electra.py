...
from modeling_electra import ElectraForMaskedLM, ElectraConfig
from transformers import Trainer, TrainingArguments

from DataCollator import DataCollatorForLanguageModelingNgram

raw_text = '../data/enhance.tsv'

tokenizer_path = "../origin_model/tokenizer"

model_path = "../origin_model/chinese-electra-180g-base-discriminator"

new_model_path = "../model_output/electra"
