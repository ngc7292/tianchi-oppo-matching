...
from modeling_nezha import NeZhaForSequenceClassification, NeZhaForSequenceClassificationWithMutilDropout
...
def run():
    ...
    for i, (train_index, val_index) in enumerate(skf.split(train_texts_aug, train_labels_aug)):
        ...
        model = NeZhaForSequenceClassificationWithMutilDropout.from_pretrained(model_name_or_path, config=config)
