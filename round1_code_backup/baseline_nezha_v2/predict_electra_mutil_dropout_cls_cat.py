...
from modeling_electra import ElectraForSequenceClassification, ElectraForSequenceClassificationWithClsCat
...
pred = run_kfold_pred(test_loader, test_texts, device=device, model_dir='./kfold-16')
