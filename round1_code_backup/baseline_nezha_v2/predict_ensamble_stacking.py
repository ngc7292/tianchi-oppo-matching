...
nezha_tokenizer = BertTokenizer(vocab_file=nezha_vocab_file, model_input_names=["input_ids", "token_type_ids", "attention_mask", "co_ocurrence_ids"])
electra_tokenizer = BertTokenizer(vocab_file=electra_vocab_file, model_input_names=["input_ids", "token_type_ids", "attention_mask", "co_ocurrence_ids"])
roberta_tokenizer = BertTokenizer(vocab_file=roberta_vocab_file, model_input_names=["input_ids", "token_type_ids", "attention_mask", "co_ocurrence_ids"])
...
nezha_train_loader = DataLoader(nezha_train_dataset, batch_size=batch_size, shuffle=False, collate_fn=nezha_data_collator)
...
electra_train_loader = DataLoader(electra_train_dataset, batch_size=batch_size, shuffle=False, collate_fn=electra_data_collator)
electra_test_loader = DataLoader(electra_test_dataset, batch_size=batch_size, shuffle=False, collate_fn=electra_data_collator)
...
roberta_train_loader = DataLoader(roberta_train_dataset, batch_size=batch_size, shuffle=False, collate_fn=roberta_data_collator)
roberta_test_loader = DataLoader(roberta_test_dataset, batch_size=batch_size, shuffle=False, collate_fn=roberta_data_collator)
...
with open("./train_enhance_data/train_x_3.txt","w") as f:
    f.write(json.dumps(train_3.tolist()))

# with open("./train_enhance_data/train_y.txt","w") as f:
#     f.write(json.dumps(train_labels.tolist()))


with open("./train_enhance_data/test_3.txt", "w") as f:
    f.write(json.dumps(test_3.tolist()))
