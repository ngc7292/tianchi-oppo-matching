...
nezha_train_loader = DataLoader(nezha_train_dataset, batch_size=128, shuffle=False, collate_fn=nezha_data_collator)
nezha_test_loader = DataLoader(nezha_test_dataset, batch_size=128, shuffle=False, collate_fn=nezha_data_collator)
...
electra_train_loader = DataLoader(electra_train_dataset, batch_size=128, shuffle=False, collate_fn=electra_data_collator)
electra_test_loader = DataLoader(electra_test_dataset, batch_size=128, shuffle=False, collate_fn=electra_data_collator)
...
roberta_train_loader = DataLoader(roberta_train_dataset, batch_size=128, shuffle=False, collate_fn=roberta_data_collator)
roberta_test_loader = DataLoader(roberta_test_dataset, batch_size=128, shuffle=False, collate_fn=roberta_data_collator)
