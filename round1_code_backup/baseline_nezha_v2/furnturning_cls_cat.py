...
from modeling_nezha import NeZhaForSequenceClassificationWithClSCat, NeZhaForSequenceClassification
...
def run():
    ...
    for i, (train_index, val_index) in enumerate(skf.split(train_texts_aug, train_labels_aug)):
        ...
        if mode == "origin":
            model = NeZhaForSequenceClassification.fro
