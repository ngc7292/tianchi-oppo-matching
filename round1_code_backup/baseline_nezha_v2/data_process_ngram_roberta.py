...
vocab_file = './roberta_tokens.txt'

raw_text = './roberta_raw_text_ngram.txt'
...
nezha_orgin_vocab = []
with open('/remote-home/zyfei/project/tianchi/models/chinese-roberta-wwm-ext-large/vocab.txt', encoding="utf-8") as f:
    for line in f.read().splitlines():
        line = line.strip()
        if line != '!':
