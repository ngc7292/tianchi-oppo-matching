...
def run_kfold_pred(test_dataloader, test_data, model_dir, device, is_save_transformer=True):
    ...
    for model_path in model_path_list:
        ...
        if is_save_transformer is True:
            test_model = NeZhaForSequenceClassificationWithMutilDropout.from_pretrained(model_path)
...
pred = run_kfold_pred(test_loader, test_texts, device=device, model_dir='./kfold-11')
