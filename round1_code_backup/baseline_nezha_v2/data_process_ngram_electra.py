...
vocab_file = './electra_tokens.txt'

raw_text = './electra_raw_text_ngram.txt'
...
nezha_orgin_vocab = []
with open('/remote-home/zyfei/project/tianchi/models/chinese-electra-180g-large-discriminator/vocab.txt', encoding="utf-8") as f:
    for line in f.read().splitlines():
        line = line.strip()
        if line != '!':
