...
class MatchingModel(nn.Module):
    def __init__(self,
                 pretrain_model_path="/remote-home/zyfei/project/tianchi/baseline_nezha/mybert/checkpoint-30000"):
...
class Dataloader:
    def __init__(self,
                 model_name_or_path="/remote-home/zyfei/project/tianchi/baseline/mybert/bert-pretrain-with-mlm-60000"):
...
@cache_results(_cache_fp="/remote-home/zyfei/project/tianchi/cache/tokenized_data_baseline_nezha", _refresh=True)
def load_data():
