...
parser.add_argument("--testfile", type=str,
                    default="'/remote-home/source/tianchi/data/gaiic_track3_round1_testA_20210228.tsv'")

args = parser.parse_args()

test_path = args.testfile

vocab_file = '/remote-home/source/tianchi/baseline_nezha_v2/nezha_token.txt'
...
pred = run_kfold_pred(test_loader, test_texts, device=device, model_dir='/remote-home/source/tianchi/baseline_nezha_v2/kfold-14')

with open('./result-14.txt', 'w') as f:
    for val in pred:
        f.write(str(val) + '\n')
