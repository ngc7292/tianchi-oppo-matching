...
r_1 = load_result("./result-11.txt")
r_2 = load_result("./result-14.txt")
r_3 = load_result("./result-15.txt")
r_4 = load_result("./result-16.txt")
...
result_e = np.concatenate([r_1, r_2, r_3, r_4], axis=-1)

result_e_avg = np.average(result_e, axis=-1)

with open("./result-average.txt", "w") as f:
