...
pred = run_kfold_pred(test_loader, test_texts, device=device, model_dir='/remote-home/source/tianchi/baseline_nezha_v2/kfold-15')

with open('./result-15.txt', 'w') as f:
    for val in pred:
        f.write(str(val) + '\n')
