...
class ElectraModel(ElectraPreTrainedModel):
    ...
    def forward(
        ...
        if self.config.is_co_ocurrence:
            ...
            hidden_states += co_ocurrence_ids
...
class ElectraForSequenceClassificationWithClsCat(ElectraPreTrainedModel):
    """
